...
## Data
### COMMUNITYNOTES
We are finalizing data integration and licensing; we will release the final dataset soon.

### CLIMATE-FEVER
CLIMATE-FEVER dataset can be downloaded from [here](https://github.com/tdiggelm/climate-fever-dataset).

### SufficientFacts
SufficientFacts dataset can be downloaded from [here](https://huggingface.co/datasets/copenlu/sufficient_facts).
